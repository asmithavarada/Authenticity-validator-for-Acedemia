...
import { Mail, Lock, Building, MapPin, Phone, User, FileText, Briefcase, ArrowRight } from 'lucide-react';
...
const AgencyRegister = () => {
  ...
  const registerMutation = useMutation(
    async () => {
      ...
      if (authorizationFile) {
        formDataObj.append('authorizationDoc', authorizationFile);
      }
      return authAPI.registerAgency(formDataObj);
    },
    {
      onSuccess: () => {
  ...
  const validateStep3 = () => {
    if (!formData.agencyId || !formData.contactPersonName || !authorizationFile) {
      toast.error('Please fill all required fields and upload authorization document');
      return false;
    }
    return true;
  };
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="absolute top-20 left-20 w-32 h-32 bg-indigo-500/10 rounded-full blur-xl animate-bounce"></div>
      ...
      >
          ...
          {[1, 2, 3].map((item) => (
            <div key={item} className="flex flex-col items-center">
              <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                step === item ? 'bg-indigo-600 text-white' : 
        ...
        <form onSubmit={handleSubmit}>
          {step === 1 && (
            ...
            >
              <div>
                <label className="block text-sm font-medium text-blue-200 mb-1">Agency Name*</label>
          ...
          {step === 3 && (
            ...
            >
              <div>
                <label className="block text-sm font-medium text-blue-200 mb-1">Agency ID*</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <div>
                <label className="block text-sm font-medium text-blue-200 mb-1">Contact Person Name*</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <div>
                <label className="block text-sm font-medium text-blue-200 mb-1">Authorization Document (PDF)*</label>
                <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-blue-400/30 border-dashed rounded-md bg-white/10">
                  <div className="space-y-1 text-center">
                    ...
                    <div className="flex text-sm text-blue-200">
                      <label htmlFor="authorization-upload" className="relative cursor-pointer bg-indigo-600 rounded-md font-medium text-white hover:bg-indigo-700 px-3 py-2">
                      ...
                      <p className="pl-1 pt-2">{authorizationFile ? authorizationFile.name : 'No file chosen'}</p>
                    </div>
          ...
          <div className="flex justify-between mt-8">
            ...
            {step < 3 ? (
              <motion.button
                ...
                type="button"
                onClick={nextStep}
                className="btn-primary ml-auto flex items-center bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 shadow-lg"
              >
        ...
        <div className="text-sm text-center mt-6 text-blue-200">
          Already have an account? <Link to="/agency/login" className="text-blue-300 hover:text-white font-medium">Login</Link>
        </div>
      </motion.div>
    </div>
  );
